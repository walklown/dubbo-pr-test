...
public final class DubboGreeterTriple {
    ...
    org.apache.dubbo.springboot.recurrent.GreeterRequest.class, org.apache.dubbo.springboot.recurrent.GreeterReply.class, MethodDescriptor.RpcType.UNARY,
    obj -> ((Message) obj).toByteArray(), obj -> ((Message) obj).toByteArray(), org.apache.dubbo.springboot.recurrent.GreeterRequest::parseFrom,
    org.apache.dubbo.springboot.recurrent.GreeterReply::parseFrom);

    private static final StubMethodDescriptor greetAsyncMethod = new StubMethodDescriptor("greet",
    org.apache.dubbo.springboot.recurrent.GreeterRequest.class, java.util.concurrent.CompletableFuture.class, MethodDescriptor.RpcType.UNARY,
    obj -> ((Message) obj).toByteArray(), obj -> ((Message) obj).toByteArray(), org.apache.dubbo.springboot.recurrent.GreeterRequest::parseFrom,
    org.apache.dubbo.springboot.recurrent.GreeterReply::parseFrom);
    ...
    public static class GreeterStub implements Greeter{
        ...
        @Override
        public org.apache.dubbo.springboot.recurrent.GreeterReply greet(org.apache.dubbo.springboot.recurrent.GreeterRequest request){
            return StubInvocationUtil.unaryCall(invoker, greetMethod, request);
        }

        public CompletableFuture<org.apache.dubbo.springboot.recurrent.GreeterReply> greetAsync(org.apache.dubbo.springboot.recurrent.GreeterRequest request){
            return StubInvocationUtil.unaryCall(invoker, greetAsyncMethod, request);
        }

        public void greet(org.apache.dubbo.springboot.recurrent.GreeterRequest request, StreamObserver<org.apache.dubbo.springboot.recurrent.GreeterReply> responseObserver){
    ...
    public static abstract class GreeterImplBase implements Greeter, ServerService<Greeter> {
        ...
        */
        ...
        public final Invoker<Greeter> getInvoker(URL url) {
            ...
            BiConsumer<org.apache.dubbo.springboot.recurrent.GreeterRequest, StreamObserver<org.apache.dubbo.springboot.recurrent.GreeterReply>> greetFunc = this::greet;
            handlers.put(greetMethod.getMethodName(), new UnaryStubMethodHandler<>(greetFunc));
            BiConsumer<org.apache.dubbo.springboot.recurrent.GreeterRequest, StreamObserver<org.apache.dubbo.springboot.recurrent.GreeterReply>> greetAsyncFunc = syncToAsync(this::greet);
